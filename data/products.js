export const categories = [
  {
    ...
    description: 'Indoor, outdoor, ADSS, duct, armored, aerial, and private-label OdiscomSupply.com fiber cable.',
  },
  {
    slug: 'connectivity',
    name: 'Connectivity',
    description: 'Connectors, jumpers, patch panels, adapters, pigtails, and termination accessories.',
  },
  {
    slug: 'tools-equipment',
    name: 'Tools & Equipment',
    description: 'Fusion splicers, cleavers, strippers, OTDRs, meters, hand tools, and field kits.',
  },
  {
    slug: 'infrastructure',
    name: 'Infrastructure',
    description: 'Conduit, innerduct, handholes, vaults, pull tape, cabinets, racks, and site materials.',
  },
  {
    slug: 'splicing-solutions',
    name: 'Splicing Solutions',
    description: 'Splice closures, trays, sleeves, storage, workstations, and full splicing trailer packages.',
  },
  {
    slug: 'test-inspect',
    name: 'Test & Inspect',
    description: 'OTDRs, power meters, light sources, inspection scopes, cleaning kits, and certification tools.',
  },
]
...
export const products = [
  {
    ...
    specs: {
      'Fiber Count': '144',
      Type: 'ADSS',
      Application: 'Aerial / OSP',
      Branding: 'OdiscomSupply.com jacket print and reel branding available',
    },
  ...
  },
  {
    ...
    specs: {
      'Fiber Count': '96',
      Type: 'Armored OSP',
      Application: 'Underground / Duct / Direct bury',
      Jacket: 'Outdoor-rated PE',
    },
  ...
  },
  {
    ...
    specs: {
      ...
      Use: 'Patch panels / equipment connections',
    },
  ...
  },
  {
    ...
    specs: {
      Includes: 'Splicer, cleaver, charger, case, tools',
      Use: 'FTTH / OSP / restoration',
      Support: 'Setup and sourcing assistance available',
      Financing: 'Available for approved contractors',
    },
  ...
  },
  {
    ...
    specs: {
      ...
      Application: 'Aerial / buried / handhole',
      Accessories: 'Trays, sleeves, brackets',
      Use: 'Long-haul and FTTH builds',
    },
  ...
  },
  {
    ...
    specs: {
      Package: 'Trailer, workbench, power, storage, lighting',
      Options: 'Generator, HVAC, tool storage, branded wrap',
      Use: 'Fiber construction and restoration crews',
      Branding: 'OdiscomSupply.com wrap available',
    },
